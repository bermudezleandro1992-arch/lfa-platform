...
const LANGUAGES: Record<LangCode, { flag: string; label: string; name: string }> = {
  es: { flag: 'https://flagcdn.com/w20/es.png', label: 'ES', name: 'Español'   },
...
export const TRANSLATIONS: Record<LangCode, Translations> = {
  es: {
    ...
    foot_titulo: 'SOMOS LFA - Liga de Fútbol Automatizada',
    ...
    redes: 'NUESTRAS REDES:', derechos: '© 2026 LFA. Todos los derechos reservados. Jugá con responsabilidad y Diversión.',
  ...
  pt: {
    ...
    foot_titulo: 'SOMOS LFA - Liga de Futebol Automatizada',
    ...
    redes: 'NOSSAS REDES:', derechos: '© 2026 LFA. Todos os direitos reservados. Jogue com responsabilidade e Diversão.',
  ...
  en: {
    ...
    foot_titulo: 'SOMOS LFA - Automated Football League',
    ...
    redes: 'OUR SOCIALS:', derechos: '© 2026 LFA. All rights reserved. Play responsibly and have Fun.',
