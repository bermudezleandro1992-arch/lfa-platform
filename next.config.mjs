...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://accounts.google.com https://www.google.com https://www.gstatic.com https://apis.google.com https://www.google.com/recaptcha/ https://www.gstatic.com/recaptcha/ https://connect.facebook.net https://www.googletagmanager.com https://*.firebaseapp.com https://*.firebase.com",
      ...
      "connect-src 'self' https://*.googleapis.com https://*.firebaseio.com wss://*.firebaseio.com https://firebasestorage.googleapis.com https://*.cloudfunctions.net https://*.run.app https://www.google.com/recaptcha/ https://recaptchaenterprise.googleapis.com https://*.binance.com https://bpay.binanceapi.com https://accounts.google.com https://apis.google.com https://graph.facebook.com https://www.google-analytics.com https://www.googletagmanager.com https://api.twitch.tv https://*.twitch.tv wss://*.twitch.tv https://*.kick.com https://www.youtube.com https://utas.s2.ea.com https://utas.s3.ea.com https://utas.s4.ea.com https://utas.s5.ea.com https://utas.s6.ea.com https://utas.s7.ea.com https://utas.s8.ea.com https://utas.s9.ea.com https://utas.s10.ea.com https://utas.s11.ea.com https://we-pes-mobile.konami.net https://pes.konami.net https://pes-gameserver.konami.net https://*.firebaseapp.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com",
      // Frames: Google login + Firebase Auth + Facebook + reCAPTCHA + YouTube + Twitch + Kick (LFA TV)
      "frame-src https://accounts.google.com https://www.google.com https://www.google.com/recaptcha/ https://*.firebaseapp.com https://somoslfa.com https://www.facebook.com https://www.youtube.com https://www.youtube-nocookie.com https://player.twitch.tv https://clips.twitch.tv https://player.kick.com https://kick.com",
...
const nextConfig = {
  ...
  async headers() {
    return [
      // Security headers en todas las rutas EXCEPTO Firebase Auth handler paths
      {
        source: '/((?!__/).*)',
  ...
  async rewrites() {
    return [
      // Firebase Auth popup handler (necesario para authDomain custom)
      {
        source: '/__/auth/:path*',
        destination: 'https://lfaofficial.firebaseapp.com/__/auth/:path*',
      },
      // Firebase JS SDK resources
      {
        source: '/__/firebase/:path*',
        destination: 'https://lfaofficial.firebaseapp.com/__/firebase/:path*',
      },
    ];
  },
};
